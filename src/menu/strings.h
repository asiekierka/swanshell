...
DEFINE_STRING(s_path_font16hans, "/NILESWAN/FONT16/ZH_HANS/DEFAULT.SFF");
DEFINE_STRING(s_path_font16hansv, "/NILESWAN/FONT16/ZH_HANS/VDEFAULT.SFF");
...
DEFINE_STRING(s_my_board_revision, "rev. %d%c");
